...
extension AppDelegate: MessagingDelegate {
    func messaging(_ messaging: Messaging, didReceiveRegistrationToken fcmToken: String) {
        ...
        Network.shared.getData(UpdateProfData.self, url: "http://homebride-sa.com/api/user/update/profile", parameters: ["fcm_token_ios" : fcmToken], method: .post) { (message, data) in }
    }
